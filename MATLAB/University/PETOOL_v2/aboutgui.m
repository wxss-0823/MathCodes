...
% ABOUTGUI Application M-file for aboutgui.fig
%    FIG = ABOUTGUI launch aboutgui GUI.
%    ABOUTGUI('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.5 24-Oct-2010 17:12:26
...
if nargin == 0  % LAUNCH GUI
    ...
    %figa = imread('about.jpg');  
    load inputfigs.mat;
    imshow(figa,'Parent',handles.axes12); 
